...
export default function DashboardPage() {
  ...
  const chartIdToTab: Record<string, typeof activeTab> = {
    ...
    'cmi-propositions': 'cmi-propositions',
  }
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="container mx-auto px-6 py-6 flex-1">
          ...
          <div className="flex-1 flex justify-center">
            <div className="text-center">
              ...
              <h2 className="text-sm text-black">
                {dashboardName || 'Global and Africa ESG & Sustainability Advisory for BFSI Market'}
              </h2>
            </div>
          </div>
        ...
        <div
          role="status"
          aria-live="polite"
          className="mb-6 flex gap-3 rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 shadow-sm"
        >
                  ...
                  <nav className="flex items-center -mb-px">
                    ...
                    {viewMode === 'tabs' && (
                      <>
                        ...
                        {isChartVisible('cmi-propositions') && (
                          <button
                            onClick={() => setActiveTab('cmi-propositions')}
                            className={`px-6 py-3 text-sm font-medium border-b-2 transition-colors ${
                              activeTab === 'cmi-propositions'
                                ? 'border-blue-500 text-blue-600'
                                : 'border-transparent text-black hover:text-black hover:border-gray-300'
                            }`}
                          >
              ...
              <div className="p-6">
                {viewMode === 'tabs' ? (
                  <>
                    ...
                    {activeTab === 'cmi-propositions' && (
                      <div id="cmi-propositions">
                        <CustomerIntelligencePropositions title="Customer Intelligence — CMI framework" />
                      </div>
                    )}
                  </>
                ) : (
